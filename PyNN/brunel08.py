...
$Id: brunel.py 869 2010-12-13 13:24:53Z pierre $
...
exfilename  = "Results/Brunel_exc_np%d_%s.raster.mat" % (np, simulator_name) # output file for excit. population  
infilename  = "Results/Brunel_inh_np%d_%s.raster.mat" % (np, simulator_name) # output file for inhib. population  
vexfilename = "Results/Brunel_exc_np%d_%s_voltage.mat"   % (np, simulator_name) # output file for membrane potential traces
vinfilename = "Results/Brunel_inh_np%d_%s.voltage.mat"   % (np, simulator_name) # output file for membrane potential traces

# write data to file
# E_net.printSpikes(exfilename)
#I_net.printSpikes(infilename)
E_net.write_data(exfilename,'spikes')
